...
public class Costumer1 {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        // 5. 将队列绑定到交换机
        channel.queueBind(Producer.DIRECT_QUEUE_1, Producer.TOPIC_EXCHANGE, "jaziel.insert");
        channel.queueBind(Producer.DIRECT_QUEUE_1, Producer.TOPIC_EXCHANGE, "jaziel.update");
        //5. 创建消费者（接收消息并处理消息）；
